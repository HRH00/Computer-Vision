...
in the /Datastore/Supplied_Data directory, with all videos of the same label class in a directory of their own
Titled with the label i.e all walking images in /Datastore/Supplied_Data/Walking. Make sure there are no empty 
directories which are not a part of the data set in /Datastore/Supplied_Data
